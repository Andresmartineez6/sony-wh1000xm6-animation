    ...
    >
      ...
      <div className="relative mx-auto max-w-[1280px] px-5 md:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-20 items-center">
          ...
          >
            <div className="relative aspect-[4/5] rounded-3xl overflow-hidden border border-white/[0.06] bg-ink-800">
              <Image
              ...
              <div
                ...
                style={{
                  boxShadow:
                    'inset 0 0 0 1px rgba(255,255,255,0.06), inset 0 -120px 80px -40px rgba(0,80,255,0.18)',
                }}
              />
          ...
          <div className="lg:col-span-7">
            ...
            <h2 className="text-gradient font-display font-bold tracking-tighter text-3xl sm:text-4xl md:text-6xl leading-[0.98]">
              De la fibra óptica<br /> al píxel perfecto.
            </h2>

            <p className="mt-6 text-white/70 text-[16px] md:text-[17.5px] leading-relaxed max-w-xl">
              Soy <span className="text-white font-medium">Andrés</span> &mdash; tengo 20 años, soy de Murcia y me apasiona
            ...
            <p className="mt-4 text-white/55 text-[15px] md:text-[16px] leading-relaxed max-w-xl">
            ...
            <div className="mt-10 grid grid-cols-2 sm:grid-cols-4 gap-px bg-white/[0.06] rounded-xl overflow-hidden border border-white/[0.06] max-w-xl">
              {HIGHLIGHTS.map((h) => (
                <div key={h.kpi} className="bg-ink-800 p-5">
                  <p className="text-gradient font-display font-bold text-2xl md:text-3xl tracking-tight">
                    {h.kpi}
                  </p>
            ...
            <div className="mt-10">
              ...
              <div className="flex flex-wrap gap-2">
                {STACK.map((s) => (
                  <span
                    key={s}
                    className="inline-flex items-center h-8 px-3.5 rounded-full text-[12px] tracking-tight font-medium text-white/75 border border-white/[0.08] bg-white/[0.025] hover:bg-white/[0.05] transition-colors"
                  >
                    {s}
                  </span>
                ))}
            ...
            <div className="mt-8 md:mt-10 flex flex-col sm:flex-row flex-wrap items-start sm:items-center gap-3 md:gap-4">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="relative inline-flex items-center gap-2 h-11 px-6 rounded-full ring-gradient text-[13.5px] font-semibold text-white"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 h-11 px-5 rounded-full text-[13.5px] font-medium text-white/70 hover:text-white border border-white/10 hover:border-white/20 transition-colors"
              >
